...
dropdown_options = [
    ...
    {'label': 'Recession Period Statistics', 'value': 'Recession Period Statstics'}
]
# List of years 
...
app.layout = html.Div([
    ...
    html.Div(id='output-container', className='chart-grid', style={'dispplay': 'flex'}),])
])
...
@app.callback(
    ...
    [Input(component_id='dropdown-statstics', component_property='value'), Input(component_id='select-year', component_property='value')])


def update_output_container(selected_statistics, input_year):
    if True == 'Recession Period Statistics':
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
	...
	# Hint:Use Vehicle_Type and Advertising_Expenditure columns
        ...
        R_chart3 = figure=px.pie(exp_rec,
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots
    ...
    elif (input_year and selected_statistics=='Yealy Statistics') :
